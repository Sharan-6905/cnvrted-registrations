...
export const NAV = {
  ...
  links: [
    ...
    { label: "Why CNVRTED", href: "#why-not-a-database" },
  ...
  cards: [
    {
      ...
      timestamp: "15m ago",
      company: "Pied Piper",
      description: "Hiring 12+ Account Executives across North America",
      source: "LinkedIn",
    ...
    },
    {
      ...
      timestamp: "1h ago",
      company: "Ramp",
      description: "$150M Series C announced. Expanding Sales team",
      source: "TechCrunch",
      intent: "HIGH" as IntentLevel,
      score: 93,
    },
    {
      ...
      timestamp: "3h ago",
      company: "Vercel",
      description: "Migrating from Segment to Snowflake",
      source: "Reddit",
    ...
    },
    {
      ...
      timestamp: "6h ago",
      company: "G2 Crowd",
      description: "User reviews spike about reporting issues",
      source: "G2",
      intent: "MEDIUM" as IntentLevel,
      score: 58,
    },
